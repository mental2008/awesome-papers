...
This file records commonly used institution-name abbreviations in `awesome-papers`.

Use it as a lightweight normalization reference when writing or polishing affiliation lines in:

* `paper-list/`
* `reading-notes/conference/`
* other venue or topic aggregation pages
